...
var attack_range=3.5 # The distance from the boss to the player which the boss will start attacking
...
func laser_attack(gap_time,beam_type):
	...
	tween.tween_property(self,"global_position",global_position+Vector3(0,6,0),0.45*Global.boss_speed
